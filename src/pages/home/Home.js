    ...
    return (  
        <div className="jumbo row mx-0 mt-5 ">
           <div className="jumbotron col-md-12 sm-mt-0 shadow-lg  pt-5 mb-5 bg-white rounded text-center text-white">
              ...
              <img src="http://s24193.pcdn.co/wp-content/uploads/2017/08/nail-salons-near-me-ENTITY-Instagram-lipstickmixtapes-e1504122361297.png" className=" img-thumbnail d-none  d-lg-inline card-img-top w-25" style={{height:"320px"}} alt=""/>
           ...
           <div className=" row mb-4 gap-3">
                <div className=" col-lg-1  d-none d-md-block d-lg-block"></div>
                <div className="col-lg-3 d-none d-sm-none d-lg-block">
                  <img className=" card-img-top rounded-circle mx-auto" src="https://tse2.mm.bing.net/th?id=OIP.bk83NuPnjJT96jhD_gDmJQHaLH&pid=Api&P=0&w=300&h=300" alt="" />
                </div>
                <div className="col-lg-3 d-none d-lg-block">  
                  <img  className=" card-img-top rounded-circle mx-auto" src="https://tse3.mm.bing.net/th?id=OIP.W3r_SUK7ujIXc5KzlHo5eAHaHa&pid=Api&P=0&w=300&h=300" alt="" />
                </div> 
                <div  className="col-lg-3  col-md-4 d-block mx-auto">   
